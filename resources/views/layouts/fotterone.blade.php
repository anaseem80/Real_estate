<footer>
        ...
        <div class="container">
            <div class="row footer-top-style">
                <div class="col-lg-4 mb-lg-0 mb-sm-5">
                    ...
                    <p class="fs-5 text-light">ايريبك شركة مصرية تأسست بهدف تقديم خدمات عقارية فى مجالات متعددة تشمل السكني , التجارى والسياحي . كما قامت ايريبك بضم مجموعة من المطورين العقارين ذوي المصداقية لكي تتمكن من عرض أكثر عدد من المشاريع المتميزة التي يمتلكها هؤلاء المطورين تحت سقف واحد.</p>
    ...
    <div class="footer-bottom-style">
        <div class="container">
            <div class="row p-3">
                <div class="col-12">
                    <p class="text-center text-light mb-0">جميع الحقوق محفوظة لدي <span class="font-english">i REBC</span></p>
                </div>
            </div>
        </div>
    </div>
