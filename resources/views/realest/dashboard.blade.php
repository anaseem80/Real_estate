...
@section('content')
    ...
    <div class="row row-sm">
        <div class="col-xl-4 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header pb-1">
                    ...
                    <p class="tx-12 mb-0 text-muted">العميل هو فرد أو شركة تشتري خدمة العقارات وقد تطورت لتشمل الوقت الفعلي
                    </p>
                </div>
                                    ...
                                    <div class="media-body">
                                        <div class="d-flex align-items-center">
                                            <div class="mt-0">
                                                ...
                                                <p class="mb-0 tx-13 text-muted">User ID: {{ $item->id }}<span
                                                        class="text-success ml-2">User email: {{ $item->useremail }}</span>
                                                </p>
                                            </div>
                ...
                <div class="product-timeline card-body pt-2 mt-1">
                    <ul class="timeline-1 mb-0">
                        <li class="mt-0"> <i class="ti-pie-chart bg-primary-gradient text-white product-icon"></i> <span
                                class="font-weight-semibold mb-4 tx-14 ">عدد العقارات </span> <a href="#"
                        ...
                        <li class="mt-0"> <i class="mdi mdi-cart-outline bg-danger-gradient text-white product-icon"></i>
                            <span class="font-weight-semibold mb-4 tx-14 ">عدد العقارات الغير مقبوله</span> <a
                        ...
                        <li class="mt-0"> <i class="ti-bar-chart-alt bg-success-gradient text-white product-icon"></i>
                            <span class="font-weight-semibold mb-4 tx-14 ">عدد الاستعلامات</span> <a href="#"
                                class="float-left tx-11 text-muted"></a>
                        ...
                        <li class="mt-0"> <i class="ti-wallet bg-warning-gradient text-white product-icon"></i> <span
                                class="font-weight-semibold mb-4 tx-14 ">عدد الابلاغات</span> <a href="#"
                                class="float-left tx-11 text-muted"></a>
                        ...
                        <li class="mt-0"> <i class="si si-eye bg-purple-gradient text-white product-icon"></i> <span
                                class="font-weight-semibold mb-4 tx-14 ">عدد المستخدمين</span> <a href="#"
                                class="float-left tx-11 text-muted"></a>
        ...
        <div class="col-md-12 col-lg-4 col-xl-4">
            <div class="card card-dashboard-eight pb-2">
                <h6 class="card-title">اعلي الدول</h6><span class="d-block mg-b-10 text-muted tx-12">احصائيه لاعلي الدول
                    المتواجد به مستخدمين للتطبيق والموقع </span>
    ...
    <div class="row row-sm row-deck">
        <div class="col-md-12 col-lg-4 col-xl-4">
            <div class="card card-dashboard-eight pb-2">
                <h6 class="card-title">اعلي المناطق</h6><span class="d-block mg-b-10 text-muted tx-12">احصائيه لاعلي
                    المناطق تواجدا للعقارات</span>
                <div class="list-group">
