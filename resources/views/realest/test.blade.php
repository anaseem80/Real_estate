                            ...
                            <a href="moreproperty/{{$mostCountries[0]->country}}">
                                ...
                                <div class="overlay">
                                    <div class="details text-light">
                                        ...
                                        <p class="text-light"><span class="english-font">{{$mostCountries[0]->count}}</span> عقار</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="moreproperty/{{$mostCountries[1]->country}}">
                                ...
                                <div class="overlay">
                                    <div class="details text-light">
                                        ...
                                        <p class="text-light"><span class="english-font text-light">{{$mostCountries[1]->count}}</span> عقار</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="moreproperty/{{$mostCountries[2]->country}}">
                                ...
                                <div class="overlay">
                                    <div class="details text-light">
                                        ...
                                        <p class="text-light"><span class="english-font text-light">{{$mostCountries[2]->count}}</span> عقار</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a href="moreproperty/{{$mostCountries[3]->country}}">
                                ...
                                <div class="overlay">
                                    <div class="details text-light">
                                        ...
                                        <p class="text-light"><span class="english-font text-light">{{$mostCountries[3]->count}}</span> عقار</p>
                                    </div>
                                </div>
                            </a>
                        </div>
