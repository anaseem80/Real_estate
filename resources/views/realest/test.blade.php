                            ...
                            <div class="item">
                                <div class="card" dir="rtl">
                                    ...
                                    <div class="card-body mt-2 p-0">
                                        <div class="px-4">
                                            <p class="text-danger fw-bold">حصري</p>
                                            <a href="detelisscreen/{{ $item->property->id }}"
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-12">
                            <div class="why-choose-card mb-2 mb-sm-4  text-center rounded">
                                <div class="icon rounded-circle m-auto"><img
                                        src="assets/img/backgrounds/high-five.png" alt=""></div>
                        ...
                        <div class="col-lg-8 my-2">
                            <div class="properti_city position-relative">
                                <a href="moreproperty/{{ $mostCountries[0]->country }}">
                                    <div class="thumb"><img class="img-fluid w-100"
                                            src="assets/img/backgrounds/pc2.jpg" alt="pc1.jpg"></div>
                                    <div class="overlay">
                                        <div class="details text-light">
                        ...
                        <div class="col-lg-4 my-2">
                            <div class="properti_city position-relative">
                                <a href="moreproperty/{{ $mostCountries[1]->country }}">
                                    <div class="thumb"><img class="img-fluid w-100"
                                            src="assets/img/backgrounds/pc1.jpg" alt="pc1.jpg"></div>
                                    <div class="overlay">
                                        <div class="details text-light">
                        ...
                        <div class="col-lg-4 my-2">
                            <div class="properti_city position-relative">
                                <a href="moreproperty/{{ $mostCountries[2]->country }}">
                                    <div class="thumb"><img class="img-fluid w-100"
                                            src="assets/img/backgrounds/pc3.jpg" alt="pc1.jpg"></div>
                                    <div class="overlay">
                                        <div class="details text-light">
                        ...
                        <div class="col-lg-8 my-2">
                            <div class="properti_city position-relative">
                                <a href="moreproperty/{{ $mostCountries[3]->country }}">
                                    <div class="thumb"><img class="img-fluid w-100"
                                            src="assets/img/backgrounds/1.jpg" alt="pc1.jpg"></div>
                                    <div class="overlay">
                                        <div class="details text-light">
