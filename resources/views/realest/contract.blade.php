    ...
    <form action="{{ route('advisors.search') }}" method="get" enctype="multipart/form-data">
        ...
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
            ...
            <div class="mb-3 mb-lg-0">
                ...
                <select class="form-control rounded-0 w-100" id="contract">
            ...
            <div class="form-group mb-3" id="budget" style="display: none">
                ...
                <input type="number" autocomplete="off" id="price" name="price" class="form-control ms-2 rounded-0" placeholder="الميزانية">
            </div>
            <div class="form-group mb-3" id="totalPrice" style="display: none">
                <label for="price">السعر الكلي</label>
                <input type="number" autocomplete="off" id="price" name="price2" class="form-control ms-2 rounded-0" placeholder="السعر الكلي">
            </div>
            <div class="mb-3 mb-lg-0" id="payMethod" style="display: none">
