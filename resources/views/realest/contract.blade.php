                        ...
                        <div class="card-body">
                            <div class="row row-sm">
                                ...
                                <div class="col-lg-4 mb-3 mb-lg-0">
                                    ...
                                    <select class="form-control ms-2 rounded-0 p-3"  id="contract" >
                                        <option selected>عايز {{ $PurposeOfPurchase }} ايجار ولا تمليك</option>
                                        <option value="ايجار">ايجار</option>
                                        <option value="تمليك">تمليك</option>
                                    </select>
                                </div>
                                <div class="col-lg-4 mb-3 mb-lg-0" id="leaseTerm" style="display: none">
