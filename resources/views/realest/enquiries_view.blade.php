...
@section('content')
    ...
    <div class="row">
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0"> الاستعلام عن العقار</th>
                                    <th class="border-bottom-0">رقم العقار المستعلم عنه</th>
        ...
        <!-- edit -->
        {{-- <div class="modal fade" id="edit_enquiry" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action='enquirydata/update' method="post">
                        {{ method_field('patch') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="enquiry.destroy" method="post">
                    {{ method_field('post') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
...
@section('js')
    ...
    <script>
        $('#edit_enquiry').on('show.bs.modal', function(event) {
