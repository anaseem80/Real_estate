                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row row-sm">
                            <div class="col-lg">
                                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                    placeholder="اسم العقار" type="text" name="name" value="{{ old('name') }}">
                                @if ($errors->has('name'))
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="catogerie_id" class="form-control SlectBox"
                                    onclick="console.log($(this).val())" onchange="console.log('change is firing')">
                                    <!--placeholder-->
                                    <option title="Volvo is a car" id="type" value="منزل">اختار نوع العقار
                                    </option>
                        ...
                        < {{-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
                                ...
                                <div class="gallery"></div> --}} {{-- ----------------------------------------------------------------------------------------------------------------------------------------------------- --}} <div class="row">
...
@section('js')
    ...
    for (i = 0; i < filesAmount; i++) { var reader=new FileReader(); reader.onload=function(event) { $($.parseHTML('<img>
